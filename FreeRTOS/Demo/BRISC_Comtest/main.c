...
#define mainCOM_TEST_BAUD_RATE  ( ( unsigned long ) 1000 )
...
#define mainNO_ERROR_CHECK_TASK_PERIOD		( 2000UL )
...
int main( void )
{
    ...
    printString("Setting up priority tasks...\n");
    vAltStartComTestTasks( tskIDLE_PRIORITY,
                           mainCOM_TEST_BAUD_RATE,
                           mainCOM_TEST_LED );

    /* Creathe the task that performs the 'check' functionality */
